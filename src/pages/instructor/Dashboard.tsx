...
import { Bell, MoreVertical, Clock, Video, MessageSquare, Play, TrendingUp, Flag, CheckCircle2, MonitorPlay, Sparkles, ArrowUpRight, LogOut, Users, Calendar, Activity } from "lucide-react";
    ...
    <div className="flex-1 overflow-y-auto flex flex-col w-full max-w-md mx-auto px-6 pb-24 bg-[#0A0A0A] text-white h-full relative">
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h3 className="text-2xl font-medium text-white tracking-tight leading-tight">Review: Intro to AI</h3>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 mb-8 bg-black/20 p-4 rounded-2xl border border-white/5">
            ...
            <div className="text-right">
              <p className="text-sm font-bold text-white flex items-center justify-end gap-1.5">
                <Clock className="w-4 h-4 text-indigo-400" /> 45m
              </p>
            </div>
          </div>
      ...
      <div className="mt-8 grid grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-3xl font-light text-white tracking-tighter">High</p>
          <p className="text-[9px] font-bold text-white/40 mt-1 uppercase tracking-widest">Top 10% student</p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 mb-3 text-indigo-400">
            ...
            <span className="text-[9px] font-bold uppercase tracking-widest">Goals Met</span>
          </div>
          <p className="text-3xl font-light text-white tracking-tighter">3<span className="text-lg text-white/30">/5</span></p>
          <p className="text-[9px] font-bold text-white/40 mt-1 uppercase tracking-widest">Monthly Target</p>
        </motion.div>
      </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest text-indigo-400">45m Total</span>
        </div>
...
function AgendaItem({ time, title, desc, onClick, delay }: any) {
  return (
    <motion.div 
    ...
    >
      <div className="flex flex-col items-center justify-center w-12 h-12 rounded-xl bg-black/40 border border-white/5 text-white font-bold text-xs shrink-0 group-hover:bg-indigo-500/20 group-hover:text-indigo-300 group-hover:border-indigo-500/30 transition-all duration-300">
